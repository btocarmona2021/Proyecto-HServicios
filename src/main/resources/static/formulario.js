...
const expresiones = {
    ...
    experiencia: /^[a-zA-ZÀ-ÿ\s]{1,200}$/, // Letras y espacios, pueden llevar acentos.
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.apellido && campos.nombre && campos.password && campos.correo && campos.telefono && campos.direccion && campos.servicio && campos.experiencia && campos.precioXHora && terminos.checked ){
